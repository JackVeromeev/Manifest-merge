...
public enum ContentMergeStrategy {
    ...
    private static Map<String, Set<String>> unify(Map<String, Set<String>> content1,
    ...
    private static Map<String, Set<String>> intersect(Map<String, Set<String>> content1,
                                              Map<String, Set<String>> content2) {
        Map<String, Set<String>> resultContent = new TreeMap<>();
        copyToTarget(content1, resultContent, Set::addAll);
    ...
    private static Map<String, Set<String>> subtract(Map<String, Set<String>> content1,
                                             Map<String, Set<String>> content2) {
        Map<String, Set<String>> resultContent = new TreeMap<>();
        copyToTarget(content1, resultContent, Set::addAll);
    ...
    private static void copyToTarget(Map<String, Set<String>> source,
